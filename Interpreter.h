...
Written by Artho Juan Pacini

Example usage for x squared:
art::Interpreter xSquaredFunction("x*x");
int result = xSquaredFunction.getResult(2);

result = 4

Example usage for a+b*(5*a), where a = 2 and b = 4:
...
namespace art 
{
    class Interpreter
    {
        ...
        Interpreter(std::string infixExpression)
        {
            //std::cout << "[Interpreter]: Building function..." << std::endl;
            ...
            //std::cout << "[Interpreter]: Interpreter built..." << std::endl;
        }
        ...
        {
            //std::cout << "[Interpreter]: Building expression 1/2..." << std::endl;
        ...
        {
            //std::cout << "[Interpreter]: Building expression 2/2..." << std::endl;
